...
class DashboardController extends Controller
{
    ...
    public function getDashboard(Request $request): JsonResponse
    {
        ...
        if (isset($includes['memberCourses'])) {
            $response['data']['memberCourses'] = $user->courses()
                ->wherePivot('status', 'accepted')
                ...
                ->limit($limit)
                ->select('courses.id', 'courses.title', 'courses.avatar', 'courses.type', 'courses.updated_at', 'courses_users.role')
                ->get()
                ->map(fn(Course $course) => $this->formatCourse($course, $course->pivot->role));
        }
        ...
        if (isset($includes['recentNotes'])) {
            ...
            $response['data']['recentNotes'] = Note::where('user_id', $userId)
                ...
                ->select('id', 'title', 'is_private', 'updated_at', 'created_at')
